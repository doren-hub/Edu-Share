...
export const TEST_BROWSE_PAPER_LIST_COLUMNS = `${TEST_BROWSE_COLUMNS},notebooklm_slide_pdf_storage_path,notebooklm_video_mp4_storage_path,notebooklm_questions_json,notebooklm_vocab_questions_json,pdf_filename`;
